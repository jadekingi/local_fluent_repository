...
% figure
% plot(sgv,theSGV_GH_Ave(:,1),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% xlabel('Gas superficial velocity(m/s)');
% ylabel('Overall Gas Holdup(-)');
% title('Overall gas holdup');
% hold on
% plot(sgv,theSGV_GH_Ave(:,2),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
...
% figure
% plot(X_Ave_localGasHoldup(:,1,1),X_Ave_localGasHoldup(:,2,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% hold on
% plot(X_Ave_localGasHoldup(:,1,2),X_Ave_localGasHoldup(:,2,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% plot(X_Ave_localGasHoldup(:,1,3),X_Ave_localGasHoldup(:,2,3),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% plot(X_Ave_localGasHoldup(:,1,4),X_Ave_localGasHoldup(:,2,4),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% xlabel('X(m)');
% ylabel('Local Gas Holdup(-)');
% title(str);
...
% end
% figure
% plot(liq_mean_v(:,1,1),liq_mean_v(:,2,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% hold on
% plot(liq_mean_v(:,1,2),liq_mean_v(:,2,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% xlabel('Gas superficial velocity(m/s)');
...
% figure
% plot(Local_liquid_velocity_Y(:,1,1),Local_liquid_velocity_Y(:,2,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% hold on
% plot(Local_liquid_velocity_Y(:,1,2),Local_liquid_velocity_Y(:,2,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% plot(Local_liquid_velocity_Y(:,1,3),Local_liquid_velocity_Y(:,2,3),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% plot(Local_liquid_velocity_Y(:,1,4),Local_liquid_velocity_Y(:,2,4),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% xlabel('Height(m)');
...
% 	figure
% 	plot(Local_liquid_velocity_x_Ave(:,1,1,sgv_index),Local_liquid_velocity_x_Ave(:,2,1,sgv_index),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% 	hold on
% 	plot(Local_liquid_velocity_x_Ave(:,1,2,sgv_index),Local_liquid_velocity_x_Ave(:,2,2,sgv_index),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% 	plot(Local_liquid_velocity_x_Ave(:,1,3,sgv_index),Local_liquid_velocity_x_Ave(:,2,3,sgv_index),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% 	plot(Local_liquid_velocity_x_Ave(:,1,4,sgv_index),Local_liquid_velocity_x_Ave(:,2,4,sgv_index),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% 	xlabel('X(m)');
...
% 	figure
% 	plot(Local_liquid_velocity_x_Ave(:,1,h_index,1),Local_liquid_velocity_x_Ave(:,2,h_index,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% 	hold on
% 	plot(Local_liquid_velocity_x_Ave(:,1,h_index,2),Local_liquid_velocity_x_Ave(:,2,h_index,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% 	plot(Local_liquid_velocity_x_Ave(:,1,h_index,3),Local_liquid_velocity_x_Ave(:,2,h_index,3),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% 	plot(Local_liquid_velocity_x_Ave(:,1,h_index,4),Local_liquid_velocity_x_Ave(:,2,h_index,4),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% 	xlabel('X(m)');
% 	ylabel('Local superifcial velocity(m/s)');
% 	title(title_str);
% 	legend('GSV = 0.01m/s','GSV = 0.02m/s','GSV = 0.03m/s','GSV = 0.04m/s');
...
% figure
% plot(small_bubble_fraction_withsgv(:,1),small_bubble_fraction_withsgv(:,2),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% xlabel('GSV(m/s)');
...
% 			temp_a_sum = riser_kl_kla_Y_sorted(index,5);
% 			count = 1;
% 			i = i + 1;
% 		end
...
% figure
% plot(riser_kl_kla_ave(:,1),riser_kl_kla_ave(:,2),'s','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% xlabel('Gas Superficial velocity(m/s)');
% ylabel('k_L(kg\bulletmm/s');
% title('k_L with GSV in riser');

% figure
% plot(riser_kl_kla_ave(:,1),riser_kl_kla_ave(:,3),'s','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% xlabel('Gas Superficial velocity(m/s)');
% ylabel('k_La(kg\bulletmm/s');
% title('k_La with GSV in riser');

% figure
% plot(riser_kl_kla_ave(:,1),riser_kl_kla_ave(:,4),'s','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% xlabel('Gas Superficial velocity(m/s)');
% ylabel('a(m^2/m^3)');
% title('a with GSV in riser');

% figure
% plot(riser_kl_kla_Y_results(1:41,1,1),riser_kl_kla_Y_results(1:41,2,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% hold on
% plot(riser_kl_kla_Y_results(:,1,2),riser_kl_kla_Y_results(:,2,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% plot(riser_kl_kla_Y_results(:,1,3),riser_kl_kla_Y_results(:,2,3),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% plot(riser_kl_kla_Y_results(:,1,4),riser_kl_kla_Y_results(:,2,4),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% xlabel('height(m)');
% ylabel('k_L(kg\bulletm/s)');
% title('k_L with height in riser');
% legend('GSV = 0.01m/s','GSV = 0.02m/s','GSV = 0.03m/s','GSV = 0.04m/s');
% hold off

% figure
% plot(riser_kl_kla_Y_results(1:41,1,1),riser_kl_kla_Y_results(1:41,3,1),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% hold on
% plot(riser_kl_kla_Y_results(:,1,2),riser_kl_kla_Y_results(:,3,2),'s','linestyle','-','linewidth',1,'Color','#103778','markerfacecolor','#103778');
% plot(riser_kl_kla_Y_results(:,1,3),riser_kl_kla_Y_results(:,3,3),'^','linestyle','-','linewidth',1,'Color','#0593a2','markerfacecolor','#0593a2');
% plot(riser_kl_kla_Y_results(:,1,4),riser_kl_kla_Y_results(:,3,4),'v','linestyle','-','linewidth',1,'Color','#ff7a48','markerfacecolor','#ff7a48');
% xlabel('height(m)');
% ylabel('k_La(kg\bulletmm/s)');
...
% figure
% plot(small_bubble_fraction(:,1),small_bubble_fraction(:,2),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
...
% end
% figure
% plot(various_bins_res(:,1),various_bins_res(:,2),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
% xlabel('Initial bin index');
% ylabel('Overall Gas Holdup');
...
figure
plot(kla_ave(:,1),kla_ave(:,2),'o','linestyle','-','linewidth',1,'Color','#151f30','markerfacecolor','#151f30');
xlabel('Initial bin index');
ylabel('Overall \it k_L\bulleta\rm(kg\bulletm/s)');
title('Overall \it k_L\bulleta \rmwith bins');